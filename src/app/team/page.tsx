      ...
      <section className="relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg sm:text-xl text-gray-400 max-w-2xl mx-auto">
            We are a passionate team of developers and advisors from the Philippines,
            dedicated to building innovative tech solutions that make a difference.
          </p>
        </div>
      </section>
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          {[
            ...
            <div
              key={value.title}
              className="p-6 rounded-2xl border border-gray-800 bg-gray-900/30 text-center"
            >
