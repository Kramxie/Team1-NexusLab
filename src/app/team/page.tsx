          ...
          {teamSections[0].members
            ...
            .map((member) => (
              <AnimatedGridItem key={member.id}>
                {/* ✅ limit width so single card looks nice */}
                <div className="group p-6 rounded-2xl border border-gray-800 bg-gray-900/50 hover:border-cyan-500/50 transition-all duration-300 text-center w-full max-w-xl">
